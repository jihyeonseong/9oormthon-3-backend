-- quests 테이블 및 데이터 생성 스크립트
-- 이미 실행 중인 MySQL에 수동으로 실행하기 위한 스크립트
...
-- 지역 기반 퀘스트 문제 데이터 삽입
INSERT IGNORE INTO quests (city, town, village, question, option_a, option_b, option_c, option_d, correct_answer, score) VALUES
